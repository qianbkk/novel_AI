...
from .api import auth, bridge, chapters, context, projects, providers, role_assignments, worldbuild, rules, foreshadowings, ai_assist, world, outline, chapter_titles, pre_production
...
app.include_router(chapter_titles.router)  # 2026-07-16：LLM 标题生成（Issue #12）
