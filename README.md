...
测试分层、聚焦命令与新增测试规则见 [`backend/tests/README.md`](backend/tests/README.md)。维护脚本的支持范围见 [`backend/scripts/README.md`](backend/scripts/README.md)。
